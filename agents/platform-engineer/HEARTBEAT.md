# HEARTBEAT.md -- Platform Engineer Checklist
...
4. If you changed UI: manually verify the arena loads and renders correctly
...
- If your work requires DB schema changes, coordinate with Founding Engineer (they own Alembic migrations).
