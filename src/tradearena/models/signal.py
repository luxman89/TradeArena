...
class SignalCreate(BaseModel):
    ...
    ai_assisted: bool = Field(
        False,
        description="True when reasoning was generated by the /signal/reasoning endpoint",
    )
...
class SignalEmitResponse(BaseModel):
    ...
    ai_assisted: bool = Field(False, description="True when reasoning was AI-generated")
